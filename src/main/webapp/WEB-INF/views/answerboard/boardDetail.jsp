...
<div class="card">
	<div class="card-body">
		...
		<div class="row my-2">
		    ...
		    <div class="col-9">
				<input type="text" class="form-control" name="content" id="content" value="${dto.content}" readonly="readonly">
			</div>
		</div>
	</div>
</div>
</form>
<button class="btn btn-primary" onclick="location.href='./modifyForm.do'" >수정</button>
